...
<body>
        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-8 is-offset-2" style = "position: relative; bottom: 50px;">
                    <h3 class="title has-text-centered has-text-grey">Escolha o Curso a Editar (Gerenciador)</h3>
                    <div class="box">
                    ...
                    <script>
                        ...
                        // Função que cria a lista, usando pagina e qnt_result_pg como seus parametros
                            ...
                            $.post('listar_curso.php', dados , function(retorna){
                            // Executa a função do script e direciona a função para a pagina listar_curso.php
            ...
            <div class="modal-content">
                ...
                <!-- Corpo da Janela Modal -->
                    ...
                    <!-- Cria o formulario cujo os valores serão redirecionados para o arquivo insere.php, funcionando de maneira similar ao outos formularios de cadastro-->
                        ...
                        <!-- Contem o campo curso-->
                        <label for="recipient-name" class="control-label">Nome Curso:</label>
                        <!-- Label acima do campo curso-->
                        <input name="nome_curso" type="text" class="form-control" id="recipient-name">
                        <!-- Caixa que permite a inserção de texto para alterar o valor de curso, similar ao da pagina cadastro_curso-->
                        </div>

                        <div class="form-group">
                        <!-- Contem o campo instituição_curso-->
                        <label for="detalhes" class="control-label">Instituição:</label>
                        <!-- Label acima do campo instituição_curso-->
                        <input name="instituição_curso" type="text" class="form-control" id="detalhes">
                        <!-- Caixa que permite a inserção de texto para alterar o valor de instituição_curso, similar ao da pagina cadastro_curso-->
                        </div>

                        <input name="curso_id" type="hidden" class="form-control" id="id-curso" value="">
                        <!-- Transfere o valor de curso_id para a pagina processa.php sem altera-lo, para que seja usado como um parametro -->
    ...
    <script type="text/javascript">
        ...
        var recipient = button.data('whatever') // Extrai o valor das colunas correspondente aos parametros contidos no botão da pagina listar curso para ser usado na janela modal, neste caso curso_id
        var recipientnome = button.data('whatevernome') // Extrai o valor das colunas correspondente aos parametros contidos no botão da pagina listar curso para ser usado na janela modal, neste caso curso
        var recipientdetalhes = button.data('whateverdetalhes') // Extrai o valor das colunas correspondente aos parametros contidos no botão da pagina listar curso para ser usado na janela modal, neste caso instituição_curso
        var modal = $(this) // Variavel que funciona como um recipiente para a atribuição das variaveis provenientes do botão editar, localizado na pagina listar_curso
        modal.find('.modal-title').text('ID Curso: ' + recipient) // Utiliza o valor de curso_id, extraido por whatever e atrebuido a variavel recipient
        modal.find('#id-curso').val(recipient) // Utiliza o valor de curso_id, extraido por whatever e atrebuido a variavel recipient
        modal.find('#recipient-name').val(recipientnome) // Utiliza o valor de curso, extraido por whatevernome e atrebuido a variavel recipientnome
        modal.find('#detalhes').val(recipientdetalhes) // Utiliza o valor de instituição_curso, extraido por whateverdetalhes e atrebuido a variavel recipientdetalhes
        })
    </script>
