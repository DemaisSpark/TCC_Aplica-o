...
// Pagina responsavel por receber os dados do botão apagar e executar a alteração no banco de dados
	...
	$curso_id = $_GET['id'];
	// Conecta $curso_id a variavel recebida pelo formulario, neste caso id, que usa seu valor como variavel de entrada, por meio do metodo POST e da conexão estabelecida com o BD por meio de $conexao

	$result_curso = "DELETE FROM curso WHERE curso_id  = '$curso_id'";
	// Deleta na a tabela curso todas as linhas cujo o valor do campo curso_id é igual ao valor proveniente de $curso_id
