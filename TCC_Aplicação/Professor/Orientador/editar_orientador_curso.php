...
<body>
        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-9 is-offset-2" style = "position: relative; bottom: 50px;">
                    <h3 class="title has-text-centered has-text-grey">Escolha a Orientação a Editar</h3>
                    <div class="box">
                    ...
                    <script>
                        ...
                        // Função que cria a lista, usando pagina e qnt_result_pg como seus parametros
                            ...
                            $.post('listar_orientador_curso.php', dados , function(retorna){
                            // Executa a função do script e aireciona a função para a pagina listar_orientador_curso.php
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <!-- Corpo da Janela Modal -->
                    ...
                    <form method="POST" action="processa_orientador_curso.php" enctype="multipart/form-data">
                    <!-- Cria o formulario cujo os valores serão redirecionados para o arquivo processa_orientador_curso.php, funcionando de maneira similar ao outos formularios de cadastro-->
                        
                        <div class="form-group">
                        <!-- Contem o campo orientador-->
                        <label for="open" class="control-label">Vagas Abertas</label>
                        <!-- Label acima do campo orientador-->
                        <input name="status_vagas" type="radio" id="open" value="aberto">
                        <!-- Caixa que permite a inserção de texto para alterar o valor de orientador, similar ao da pagina cadastro_orientador-->
                        <label for="closed" class="control-label">Vagas Fechadas</label>
                        <!-- Label acima do campo orientador-->
                        <input name="status_vagas" type="radio" id="closed" value="fechado" checked>
                        </div>
                    
                        <div class="form-group">
                        <!-- Contem o campo orientador-->
                        <label for="detalhes" class="control-label">Temas do Orientador:</label>
                        <!-- Label acima do campo orientador-->
                        <textarea name="temas" type="text" class="form-control" id="detalhes"></textarea>
                        <!-- Caixa que permite a inserção de texto para alterar o valor de orientador, similar ao da pagina cadastro_orientador-->
                        </div>

                        <input name="orientador_id" type="hidden" class="form-control" id="id-orientador" value="">
                        <!-- Transfere o valor de orientador_id para a pagina processa_orientador_curso.php sem altera-lo, para que seja usado como um parametro -->
    ...
    <script type="text/javascript">
        ...
        var recipient = button.data('whatever') // Extrai o valor das colunas correspondente aos parametros contidos no botão da pagina listar_orientador_curso para ser usado na janela modal, nest caso orientador_id
        var recipientnome = button.data('whatevernome') // Extrai o valor das colunas correspondente aos parametros contidos no botão da pagina listar_orientador_curso para ser usado na janela modal, nest caso orientador
        var recipientdetalhes = button.data('whateverdetalhes') // Extrai o valor das colunas correspondente aos parametros contidos no botão da pagina listar_orientador_curso para ser usado na janela modal, neste caso instituição
        var modal = $(this) // Variavel que funciona como um recipiente para a atribuição das variaveis provenientes do botão editar, localizado na pagina listar_orientador_curso
