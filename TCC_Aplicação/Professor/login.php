...
// Garante que a pagina login.php não possa ser diretamente acessada, sem preencher os campos usuario e senha na pagina professor.php, neste caso redireciona para a pagina professor.php
...
$querys = "select nome from usuario where usuario = '{$usuario}' and senha = md5('{$senha}')";
...
$querysq = "select email from usuario where usuario = '{$usuario}' and senha = md5('{$senha}')";
